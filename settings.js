...
SESSION_ID: process.env.SESSION_ID === undefined ? 'VAJIRA-MD=rAFFQQIZ#uxQyrkB10dhPwbai_xwz4T1Y3EOGS6ebbblBN_WhUQw' : process.env.SESSION_ID,
OWNER_NUMBER: process.env.OWNER_NUMBER === undefined ? '260 979550327' : process.env.OWNER_NUMBER,   
